...
class MixStructureBlock(nn.Module):
    def __init__(self, dim):
        ...
        #self.deformable_conv0 = build_deformable_conv3()
...
class MixDehazeNet(nn.Module):
    def __init__(self, in_chans=3, out_chans=4,
        ...
        self.dcn = DCNv3_pytorch(kernel_size=3,group=4,channels=96,center_feature_scale=True)
...
# a=MixDehazeNet(embed_dims=[24, 48, 96, 48, 24],
#         depths=[1, 1, 2, 1, 1])
# x=torch.randn(22,96,256,256)
# dcn=DCNv3_pytorch(kernel_size=3,channels=96,group=4,center_feature_scale=True)
# output=dcn(x)
# print(output.shape)
# for name,layer in a.named_children():
